...
#        train_data=np.load('E:\\ysdeeplearn\\deepcode\\deeptrain\\何飞\yumu\\data.npy')
...
#        
        ...
        #        sess.run(train_step, feed_dict={xs: train_data, ys: train_label,on_train: True, keep_prob: 0.5,pkeep_conv:1})
                _,ll=sess.run([train_step,h_fc2], feed_dict={xs: image_batch_v, ys:label_batch_v,on_train: True, keep_prob: 0.4,pkeep_conv:1})
