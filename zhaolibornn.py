...
#        train_data=train_data/zui
    ...
    with tf.Graph().as_default():
        ...
        param_dict = {
                ...
                'n_inputs' : 280,#train_data_width,   # data input 
    ...
    #    choice_num_not = param_dict['choice_num_not']
        ...
        _x = tf.placeholder(tf.float32, [None, 2800])
        ...
        with tf.Session() as sess:
            ...
            for step in range(total_steps + 1):
                ...
                sess.run(train_op, feed_dict={_x: image_batch_v, y: label_batch_v, keep_prob: 0.5, batch_size: image_batch_v.shape[0]})
                # Train Accuracy
        ...
        #            test_x, test_y = mnist.test.images, mnist.test.labels
                    print('Test', step,t)
                    s1.append(t)
                    s=sess.run(y, feed_dict={_x: test_data, y: test_label, keep_prob: 1, batch_size: test_data.shape[0]})
