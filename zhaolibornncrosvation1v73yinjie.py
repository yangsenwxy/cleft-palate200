...
#    train_label=np.array(load_matrix,dtype='float32')
    ...
    load_train_data=r'E:\ysdeeplearn\deepcode\deeptrain\ci\data_rf3.mat'
...
#    train_data=np.load(r'E:\ysdeeplearn\deepcode\deeptrain\何飞\yumu\train_data.npy')
    ...
    load_test_label = r'E:\ysdeeplearn\deepcode\deeptrain\ci\label_rf3.mat'
...
#    train_data,train_label,test_data,test_label=get()
    with tf.Graph().as_default(): 
        ...
        param_dict = {
                ...
                'n_inputs' : 39,#train_data_width,   # data input 
                'n_steps' :141,    # time steps
    ...
    #    choice_num_not = param_dict['choice_num_not']
        ...
        _x = tf.placeholder(tf.float32, [None, 5499])
