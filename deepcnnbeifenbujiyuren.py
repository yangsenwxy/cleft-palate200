...
s=[]
s1=[]
load_test_label = r'E:\ysdeeplearn\deepcode\deeptrain\sp256\基于人的\42\test_label.mat'
...
load_train_label= r'E:\ysdeeplearn\deepcode\deeptrain\sp256\基于人的\42\train_label.mat'
...
load_train_data= r'E:\ysdeeplearn\deepcode\deeptrain\sp256\基于人的\42\train_data.mat'
...
load_test_data= r'E:\ysdeeplearn\deepcode\deeptrain\sp256\基于人的\42\test_data.mat'
...
#        sess.run(train_step, feed_dict={xs: train_data3, ys:label3,on_train: True, keep_prob: 0.5,pkeep_conv:1})
    ...
    print('time')
    new1=os.path.join(path1,str(42))
    new2=new1+p
    new3=new1+p1
    np.save(new2,s)
    np.save(new3,s1)
